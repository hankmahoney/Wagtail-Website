...
class ServicePage(Page):
    ...
    def clean(self):
        ...
        if not self.internal_page and not self.external_page:
            raise ValidationError({
                'internal_page': ValidationError("You must alwasy select a page OR enter an external URL"),
                'external_page': ValidationError("You must alwasy select a page OR enter an external URL"),
            })
